...
public class TensorFlowInferenceInterface {
    ...
    public void run(String[] outputNames, boolean enableStats) {
        ...
        try {
            if (enableStats) {
                Session.Run r = runner.setOptions(io.antmedia.plugin.tensorflow.detection.RunStats.runOptions()).runAndFetchMetadata();
                fetchTensors = r.outputs;

                if (runStats == null) {
                    runStats = new io.antmedia.plugin.tensorflow.detection.RunStats();
                }
    ...
    // Mutable state.
    private io.antmedia.plugin.tensorflow.detection.RunStats runStats;
}